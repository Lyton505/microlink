function Terms() {
  return (
    <div>
      ...
      <p>
        Welcome to MicroLink! These terms and conditions outline the rules and
        regulations for the use of MicroLink's Website.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use MicroLink if you do not agree to take
